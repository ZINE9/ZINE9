...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE client SET name = ?, age = ?, address = ?, phone = ?, weight = ?, weight_unit = ?, gender = ?, yes_no_option = ?, command = ?, select_option1 = ?, select_option2 = ?, select_option3 = ?, start = ? WHERE id = ?";
    $stmt = $conn->prepare($updateSql);
    $stmt->bind_param('sisssssssssssi', $name, $age, $address, $phone, $weight, $weight_unit, $gender, $yes_no_option, $command, $select_option1, $select_option2, $select_option3, $date, $userId);
...
<body>
    <form method="POST" class="form-container">
        ...
        <a href="view_users.php" class="back-link">Cancel</a>
    </form>
</body>
</html>
